...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      components={{
        Root: ({ className, rootRef, ...props }: React.ComponentPropsWithRef<'div'> & { rootRef?: React.Ref<HTMLDivElement> }) => {
          return (
            <div
              data-slot="calendar"
              ref={rootRef}
        ...
        Chevron: ({ className, orientation, ...props }: React.ComponentPropsWithRef<'svg'>) => {
          if (orientation === 'left') {
            return (
