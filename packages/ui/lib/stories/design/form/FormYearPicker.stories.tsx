...
import { FormYearPicker } from '#customs/components/FormYearPicker.tsx';
import { Button } from '#shadcn/components/ui/button.tsx';

// 1. Meta
/**
 * FormController 전용 YearPicker(단수) 컴포넌트입니다.
 * react-day-picker 속성 일부와 다음 속성을 지원합니다.
 */
const meta = {
  title: 'Design/Form/YearPicker',
...
export const Default: Story = {
  args: {
    ...
    fromDate: new Date().sub('decade', 1, { adjust: true }),
    toDate: new Date().add('decade', 1, { adjust: true }),
