...
import { FormYearRange } from '#customs/components/FormYearRange.tsx';
import { Button } from '#shadcn/components/ui/button.tsx';

// 1. Meta
/**
 * FormController 전용 YearRange 컴포넌트입니다.
 * react-day-picker 속성 일부와 다음 속성을 지원합니다.
 */
const meta = {
  title: 'Design/Form/YearRange',
  component: FormYearRange,
  argTypes: {
    control: {
...
} satisfies Meta<typeof FormYearRange>;
