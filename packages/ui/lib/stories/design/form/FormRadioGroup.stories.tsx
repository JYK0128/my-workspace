...
import { FormRadioGroup } from '#customs/components/FormRadioGroup.tsx';
...
// 1. Meta
/**
 * FormController 전용 RadioGroup 컴포넌트입니다.
 * 기본적인 input[type=radio] 속성과 함께 다음 속성을 지원합니다.
 */
const meta = {
  title: 'Design/Form/RadioGroup',
  ...
  decorators: [(Story) => {
    const schema = z.object({
      input: z.enum(['item01', 'item02', 'item03']),
    }).default({
      input: '' as never,
    });
