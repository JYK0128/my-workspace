...
import { FormDateMultiPicker } from '#customs/components/FormDateMultiPicker.tsx';
...
// 1. Meta
/**
 * FormController 전용 DatePicker(복수) 컴포넌트입니다.
 * react-day-picker 속성 일부와 다음 속성을 지원합니다.
 */
const meta = {
  title: 'Design/Form/DateMultiPicker',
  component: FormDateMultiPicker,
  argTypes: {
    control: {
...
} satisfies Meta<typeof FormDateMultiPicker>;
